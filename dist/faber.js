...
MediumEditorComponent = (function() {
  ...
  MediumEditorComponent.prototype.name = 'Rich Text';

  MediumEditorComponent.prototype.id = 'rich-text';

  MediumEditorComponent.prototype.type = 'element';

  MediumEditorComponent.prototype.template = '<div class="rich-text" data-tust-html><br/></div>';

  MediumEditorComponent.prototype.editor = null;

  MediumEditorComponent.prototype.init = function($element, initialContent, update) {
    var opts;
    opts = {
  ...
  MediumEditorComponent.prototype.selected = function($element, update) {
    return $element[0].getElementsByClassName('rich-text')[0].focus();
  };

  MediumEditorComponent.prototype.unselected = function($element, update) {
 ...
 */
var version = {
  full: '1.2.16-build.31+sha.7cccb8b',    // all of these placeholder strings will be replaced by grunt's
...
window.faber = angular.module('faber', ['ngAnimate']).constant('faberConfig', {
  expanded: true,
  prefix: 'faber',
  components: [MediumEditorComponent]
...
faber.controller('BlockController', function($rootScope, $scope, $log, componentsService, contentService) {
  ...
  $scope.components = $scope.component.type === 'element' ? [] : componentsService.findNonTopLevelOnly();
      ...
      return {
        ...
        post: function($scope, $element, $attrs) {
          ...
          $scope.indexRange = function() {
            ...
            res = [];
            min = 0;
            max = $scope.$parent && $scope.$parent.block ? Math.max($scope.$parent.block.blocks.length - 1, min) : min;
...
faber.directive('faberComponentRenderer', function($rootScope, $http, $templateCache, $compile, contentService) {
  return {
    require: '^faberBlock',
    restrict: 'AE',
      ...
      $scope.renderer = {
        ...
        select: function(evt) {
          ...
          if ($scope.component.selected) {
            $scope.component.selected($element, this.update);
          }
        ...
        unselect: function() {
          if ($scope.component.unselected) {
            $scope.component.unselected($element, this.update);
          }
      ...
      $scope.$watch('component', function() {
        ...
        if ($scope.component && $scope.component.template) {
          ...
          if ($scope.component.init) {
            $scope.component.init($element, $scope.block.content, $scope.renderer.update);
          }
